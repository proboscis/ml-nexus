...
from ml_nexus.docker.builder.builder_utils.schematics_for_setup_py import schematics_with_setup_py, \
...
setup_py_schematics_of_sam2 = schematics_with_setup_py(target=sam2_project, )
...
test_context: IProxy = p_docker_env.run_context().with_upload(
    Path('./src')
).run_script(f"""
echo ======== BEGIN SCRIPT ========
echo $UPLOAD_0
