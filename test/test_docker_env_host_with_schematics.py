...
async def test_docker_env_multiple_project_types(schematics_universal, new_DockerEnvFromSchematics, logger):
    ...
    test_cases = [
        ("UV project", ProjectDir("test_uv", kind="uv"), "python -c 'print(\"UV works\")'"),
        ("Rye project", ProjectDir("test_rye", kind="rye"), "python -c 'print(\"Rye works\")'"),
        ("Setup.py project", ProjectDir("test_setuppy", kind="auto"), "python -c 'import test_setuppy; print(\"Setup.py works\")'"),
        ("Requirements project", ProjectDir("test_requirements", kind="auto"), "python -c 'import pandas; print(\"Requirements works\")'"),
    ]
