...
async def test_docker_build_functions():
    ...
    print(
        "✓ build_image_with_copy and build_image_with_rsync have docker context support"
    )
...
async def test_empty_context():
    ...
    client = LocalDockerClient(
        _a_system=mock_a_system, _logger=mock_logger, _ml_nexus_docker_build_context=""
    )
